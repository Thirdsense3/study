          ...
          <div className="sidebar-widget-list mt-20">
            <ul>
              <li>
                <div className="sidebar-widget-list-left">
                  <button>
                    <span className="checkmark"></span> All Sizes{' '}
                  </button>
                </div>
              </li>
              <li>
                <div className="sidebar-widget-list-left">
                  <button className="text-uppercase">
                    {' '}
                    <span className="checkmark"></span>x{' '}
                  </button>
                </div>
              </li>
              <li>
                <div className="sidebar-widget-list-left">
                  <button className="text-uppercase">
                    {' '}
                    <span className="checkmark"></span>m{' '}
                  </button>
                </div>
              </li>
              <li>
                <div className="sidebar-widget-list-left">
                  <button className="text-uppercase">
                    {' '}
                    <span className="checkmark"></span>xl{' '}
                  </button>
                </div>
              </li>
              <li>
                <div className="sidebar-widget-list-left">
                  <button className="text-uppercase">
                    {' '}
                    <span className="checkmark"></span>xxl{' '}
                  </button>
                </div>
              </li>
            </ul>
